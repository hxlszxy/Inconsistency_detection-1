...
from compare import get_edb_and_nvd_soft_origin
from compare import clean_edb_and_nvd_softname_version
from compare import keep_same_version_of_edb_and_nvd
...
from detect_diff import keep_not_same_version_of_edb_and_nvd
...
from edb_parser import get_softname_and_version_of_edb

if __name__ == "__main__":
    # get_softname_and_version_of_edb()
    ...
    # get_edb_and_nvd_soft_origin()
    # clean_edb_and_nvd_softname_version()

    keep_not_same_version_of_edb_and_nvd()
