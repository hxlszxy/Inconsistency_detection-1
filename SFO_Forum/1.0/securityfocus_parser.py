...
def get_softname_and_version_of_securityfocus():
    securityfocus_data_path = os.getcwd() + '/data/securityfocus/'  # 存放securityfocus的文件夹
    securityfocus_data_filename = 'simple_data_of_securityfocus.txt'
    ...
    with open(securityfocus_data_file_path, 'r', encoding='UTF-8') as securityfocus_f:  # 打开文件
        ...
        for securityfocus_line in securityfocus_lines:
            raw_data = securityfocus_line.split()  # 按空格作为分隔符号切割字符串
